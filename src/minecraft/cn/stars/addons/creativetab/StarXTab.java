...
public final class StarXTab extends CreativeTabs implements GameInstance {
    ...
    public void displayAllReleventItems(final List<ItemStack> items) {
        ...
        baseCompound.setString("CustomName", "StarX Client");
        ...
        baseCompound1.setString("CustomName", "\"" + "StarX Client" + "\"");
