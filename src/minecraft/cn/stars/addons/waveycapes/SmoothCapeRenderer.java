...
public class SmoothCapeRenderer
{
    ...
    private void modifyPoseStackSimulation(final CustomCapeRenderLayer layer, final PoseStack poseStack, final AbstractClientPlayer abstractClientPlayer, final float delta, final int part) {
        ...
        final float naturalWindSwing = layer.getNaturalWindSwing(part);
    ...
    private static void addLeftVertex(final WorldRenderer worldrenderer, Matrix4f matrix, Matrix4f oldMatrix, float x1, float y1, final float z1, float x2, float y2, final float z2, final int part) {
        if (x1 < x2) {
            final float i = x1;
            x1 = x2;
            x2 = i;
    ...
    private static void addRightVertex(final WorldRenderer worldrenderer, Matrix4f matrix, Matrix4f oldMatrix, float x1, float y1, final float z1, float x2, float y2, final float z2, final int part) {
        if (x1 < x2) {
            final float i = x1;
            x1 = x2;
            x2 = i;
    ...
    private static void addBottomVertex(final WorldRenderer worldrenderer, Matrix4f matrix, Matrix4f oldMatrix, float x1, float y1, final float z1, float x2, float y2, final float z2, final int part) {
        if (x1 < x2) {
            final float i = x1;
            x1 = x2;
            x2 = i;
    ...
    private static WorldRenderer vertex(final WorldRenderer worldrenderer, Matrix4f matrix4f, final float f, final float g, final float h) {
    ...
    private static void addTopVertex(final WorldRenderer worldrenderer, Matrix4f matrix, Matrix4f oldMatrix, float x1, float y1, final float z1, float x2, float y2, final float z2, final int part) {
        if (x1 < x2) {
            final float i = x1;
            x1 = x2;
            x2 = i;
