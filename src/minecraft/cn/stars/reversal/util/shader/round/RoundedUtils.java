...
public class RoundedUtils {
    ...
    public static ShaderUtils roundedShader = new ShaderUtils("reversal/shaders/roundedRect.frag");
    public static ShaderUtils roundedOutlineShader = new ShaderUtils("reversal/shaders/roundRectOutline.frag");
    private static ShaderUtils roundedTexturedShader = new ShaderUtils("reversal/shaders/roundRectTextured.frag");
    private static ShaderUtils roundedGradientShader = new ShaderUtils("reversal/shaders/roundedRectGradient.frag");
