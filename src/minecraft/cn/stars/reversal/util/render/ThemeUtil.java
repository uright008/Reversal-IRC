        ...
        switch (type) {
            ...
            case ARRAYLIST: {
                if (ModuleInstance.getMode("ClientSettings", "Color Type").getMode().equals("Rainbow")) {
                    ...
                    color = ColorUtils.INSTANCE.interpolateColorsBackAndForth((int) (20 * (1 / speed)), (int) colorOffset * 4, new Color(Reversal.CLIENT_THEME_COLOR_BRIGHT), new Color(Reversal.CLIENT_THEME_COLOR_BRIGHT_2), true);
                }
                break;
            }
