...
import cn.stars.reversal.ui.gui.mainmenu.MenuTextButton;
import cn.stars.reversal.util.animation.rise.Animation;
import cn.stars.reversal.util.animation.rise.Easing;
import cn.stars.reversal.util.misc.WebUtil;
...
public class GuiMainMenu extends GuiScreen implements GameInstance {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.image(new ResourceLocation("reversal/images/reversal.png"), width / 2f - 110, (float) animation.getValue() - 50, 280, 190);

        // 测试版 watermark
        if (Reversal.BRANCH == Branch.SNAPSHOT) {
            RenderUtil.image(new ResourceLocation("reversal/666.png"), width - 110, 0, 100, 100);
        ...
        psr.drawString("Minecraft 1.8.9 (Reversal/mcp/vanilla)", 2, height - 36, ColorUtil.withAlpha(stringColor, (int) textHoverAnimation.getValue()).getRGB());
