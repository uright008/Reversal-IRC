...
import cn.stars.reversal.ui.gui.mainmenu.MenuButton;
...
public class CuriosityMainMenu extends GuiScreen implements GameInstance {
    ...
    private CuriosityTextButton singlePlayerButton, multiPlayerButton, settingsButton, viaVersionButton, exitButton, cbButton, updateLogButton, loginButton, donateButton;
    ...
    /*    boolean isHoveringLeft = RenderUtil.isHovered(0, height - 37, 140, 37, mouseX, mouseY);
        ...
        regular18.drawCenteredString("Copyright © 2024 Stars, All rights reserved.", this.width / 2f, this.height - 10, colorAnimation.getOutput().getRGB());
    ...
    public void initGui() {
        ...
        this.viaVersionButton = new CuriosityTextButton(45, this.height / 6f + 170, 120, 35, () -> mc.displayGuiScreen(new CuriosityViaMenu(this)),
                "跨版本", "d", true, 10, 44, 11);
        this.donateButton = new CuriosityTextButton(45, this.height / 6f + 215, 120, 35, () -> mc.displayGuiScreen(new GuiDonate()),
        ...
        // 简化MouseClicked方法
        this.buttons = new CuriosityTextButton[] {this.singlePlayerButton, this.multiPlayerButton, this.settingsButton, this.viaVersionButton, this.exitButton, this.cbButton, this.updateLogButton, this.loginButton, this.donateButton} ;
    }
