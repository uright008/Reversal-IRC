package cn.stars.starx.ui.splash.impl;

import cn.stars.starx.ui.splash.LoadingScreenRenderer;
import cn.stars.starx.ui.splash.SplashScreen;
import cn.stars.starx.ui.splash.utils.Image;
...
public class FadeInOutLoadingScreen extends LoadingScreenRenderer {
    ...
    public void init() {
        super.init();
        gs1 = new FadeInOutImage(new ResourceLocation("starx/images/splash.png"));
    }
