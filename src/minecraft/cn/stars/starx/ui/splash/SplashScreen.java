...
import cn.stars.starx.ui.splash.impl.FadeInOutLoadingScreen;
import cn.stars.starx.ui.splash.utils.AsyncContextUtils;
import cn.stars.starx.ui.splash.utils.AsyncGLContentLoader;
import cn.stars.starx.ui.splash.utils.Interpolations;
import cn.stars.starx.ui.splash.utils.Rect;
...
public class SplashScreen {
    ...
    private static final Animation animation = new Animation(Easing.EASE_IN_EXPO, 2000);
    private static final Animation animation2 = new Animation(Easing.EASE_IN_EXPO, 2000);
...
//                        System.out.println(progress);
                        ...
                        Rect.draw(0, height - 5, animation.getValue(), 5, ColorUtil.hexColor(255,255,255, 150 + (int) animation2.getValue()), Rect.RectType.EXPAND);

                        String text = (int)animation2.getValue() + "%";
                        FontManager.getRegular(32).drawString(text, animation.getValue() - 4 - FontManager.getRegular(32).width(text), height - 20, ColorUtil.hexColor(255,255,255, 150 + (int) animation2.getValue()));
...
//        hide = false;
    ...
    public static void setProgress(int progress, String detail) {
        ...
        StarXLogger.info("[Startup] " + progress + "% - " + detail);
    }
