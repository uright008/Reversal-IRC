...
public class GuiMainMenuNew extends GuiScreen implements GameInstance {
    ...
    //    NORMAL_BLUR_RUNNABLES.add(() -> RenderUtil.rectangle(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), Color.BLACK));
        ...
        psr.drawString("Minecraft 1.8.8 (原版/StarX)", 2, height - 36, ColorUtil.withAlpha(stringColor, (int) textHoverAnimation.getValue()).getRGB());
        psr.drawString("OptiFine_1.8.8_HD_U_I7", 2, height - 24, ColorUtil.withAlpha(stringColor, (int) textHoverAnimation.getValue()).getRGB());
