...
public class RoundedUtils {
    ...
    public static ShaderUtils roundedShader = new ShaderUtils("starx/shaders/roundedRect.frag");
    public static ShaderUtils roundedOutlineShader = new ShaderUtils("starx/shaders/roundRectOutline.frag");
    private static ShaderUtils roundedTexturedShader = new ShaderUtils("starx/shaders/roundRectTextured.frag");
    private static ShaderUtils roundedGradientShader = new ShaderUtils("starx/shaders/roundedRectGradient.frag");
