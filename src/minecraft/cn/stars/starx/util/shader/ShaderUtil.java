package cn.stars.starx.util.shader;
...
public class ShaderUtil implements GameInstance {
    ...
    public static String getShaderResource(final String resource) {
        try {
            final InputStream inputStream = RESOURCE_MANAGER.getResource(new ResourceLocation("starx/shader/" + resource)).getInputStream();
