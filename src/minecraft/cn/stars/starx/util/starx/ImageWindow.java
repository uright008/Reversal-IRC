...
public class ImageWindow {
    public static void load() {
        Thread thread = new Thread(() ->{
            ...
            // image
            try {
                ImageIcon imageIcon = new ImageIcon(MiscUtil.inputStreamToByteArray(ImageWindow.class.getResourceAsStream("/assets/minecraft/starx/images/imagescreen.jpg"))); // 这里替换为你图片的路径
