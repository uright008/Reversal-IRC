package cn.stars.starx.music.api;

import cn.stars.starx.StarX;
import cn.stars.starx.music.MusicUtil;
import cn.stars.starx.music.api.base.*;
...
public class MusicAPI {
    ...
    private static String fetch(String api) {
        ...
        do {
            try {
                ...
                StarXLogger.error("[MusicPlayer] Failed to fetch " + api + ". Retry...");
            }
        } while (result == null);
        return result;
    }
    ...
    public static QRCode genQRCode() throws IOException {
        StarXLogger.info("[MusicPlayer] Generating QR code...");
    ...
    public static ScanResult getScanResult(String key) {
        StarXLogger.info("[MusicPlayer] Checking scan result...");
    ...
    public static void updateUserInfo() {
        StarXLogger.info("[MusicPlayer] Updating user info...");
    ...
    public static List<PlayList> getUserPlayLists() {
        StarXLogger.info("[MusicPlayer] Getting user playlists...");
    ...
    public static PlayList getDailySongs() {
        StarXLogger.info("[MusicPlayer] Getting daily songs..");
    ...
    public static void fetchMusicList(PlayList playList, int offset) {
        StarXLogger.info("[MusicPlayer] Fetching music list for id [" + playList.getId() + "]...");
    ...
    public static List<PlayList> getRecommendedPlayLists() {
        StarXLogger.info("[MusicPlayer] Getting recommended playlists...");
    ...
    public static LyricPair getLyrics(long id) {
        StarXLogger.info("[MusicPlayer] Getting lyrics for id [" + id + "]");
    ...
    public static String getMusicURL(long id, boolean retry) {
        ...
        try {
            ...
            StarXLogger.error("[MusicPlayer] Failed to get exhigh music [" + id + "], retry...");
    ...
    public static PlayList search(String keywords) {
        StarXLogger.info("[MusicPlayer] Searching keywords [" + keywords + "]");
