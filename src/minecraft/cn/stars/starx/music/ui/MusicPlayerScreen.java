...
import cn.stars.starx.music.thread.SearchMusicThread;
import cn.stars.starx.music.ui.component.impl.CategoryButton;
import cn.stars.starx.music.ui.component.impl.IconButton;
import cn.stars.starx.music.ui.component.impl.UserButton;
import cn.stars.starx.music.ui.component.slider.PlayerSlider;
import cn.stars.starx.music.ui.component.slider.VolumeSlider;
...
public class MusicPlayerScreen extends GuiScreen {
    ...
    //    NanoUtil.scaleStart(x + width / 2, y + height / 2, windowAnim.getOutput().floatValue());
        ...
        RenderUtil.image(new ResourceLocation("starx/images/music/netease.png"), x + 12f, y + 10f, 16, 16);
        ...
        if (currentGUI.parent != null) {
            RenderUtil.image(new ResourceLocation("starx/images/music/arrow-left.png"), x + leftWidth + 5f, y + 6f, 16f, 16f,
