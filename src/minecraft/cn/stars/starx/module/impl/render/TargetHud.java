...
public final class TargetHud extends Module {
    ...
    private final ModeValue mode = new ModeValue("Mode", this, "Normal", "Normal", "Simple", "Classic", "Tecnio", "Other", "FpsEater3000", "Exhibition", "OldExhibition", "Remix");
    ...
    private void render(final EntityLivingBase target) {
        ...
        int color = StarX.CLIENT_THEME_COLOR_BRIGHT;
        ...
        // If the user is on the blend theme blend accordingly.
            ...
            color = ColorUtil.mixColors(color1, color2, (Math.sin(Hud.ticks + 0 * 0.4f) + 1) * 0.5f).hashCode();
        }
