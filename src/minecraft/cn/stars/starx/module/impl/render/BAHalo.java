...
public class BAHalo extends Module {
    private final ModeValue mode = new ModeValue("Student", this, "Shiroko", "Shiroko", "Hoshino", "Aris", "Yuuka", "Natsu", "Reisa", "Shiroko*Terror");
    ...
    public void drawShirokoHalo() {
        ...
        RenderUtils.color(new Color(0 + (int) (animation.getValue() * 1800), (int) (230 + animation.getValue() * 200), 250, 220));
    ...
    public void drawShiroko_TerrorHalo() {
        ...
        RenderUtils.color(new Color(79,112,117, 255));
...
// 使光环中心随玩家朝向旋转
        ...
        RenderUtils.color(new Color(200,200,250,220));
...
// 绘制小五角星
    ...
    public void drawNatsuHalo() {
        ...
        RenderUtils.color(new Color(254,200,200, 240));
    ...
    public void drawYuukaHalo() {
        ...
        // 绘制圆1
        RenderUtils.color(new Color(80, 150, 180,250));
        ...
        // 绘制圆2
        RenderUtils.color(new Color(30,30,30,200));
    ...
    public void drawHoshinoHalo() {
        ...
        RenderUtils.color(new Color(237, 110 + (int) (animation.getValue() * 600), 183, 220)); // RGB for pink
    ...
    public void drawArisHalo() {
        ...
        RenderUtils.color(new Color(161,253,228,220));
