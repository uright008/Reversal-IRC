    ...
    public void doRender(EntityPlayer entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (model != null)
        {
            ...
            if (!mwpd.playerData.playCustomAnim)
            {
                ...
                //Layer 1
                if (entity.getItemInUse() != null) {
                    CustomItemActiveAnim(mwpd, MMDModelManager.PlayerData.EntityStateLayer1.Item1Right, "1", entity.getItemInUse().getItem().getUnlocalizedName().replace(':', '.'), false);
                    CustomItemActiveAnim(mwpd, MMDModelManager.PlayerData.EntityStateLayer1.Item2Right, "2", entity.getItemInUse().getItem().getUnlocalizedName().replace(':', '.'), false);
                    CustomItemActiveAnim(mwpd, MMDModelManager.PlayerData.EntityStateLayer1.Item3Right, "3", entity.getItemInUse().getItem().getUnlocalizedName().replace(':', '.'), false);
                    CustomItemActiveAnim(mwpd, MMDModelManager.PlayerData.EntityStateLayer1.Item4Right, "4", entity.getItemInUse().getItem().getUnlocalizedName().replace(':', '.'), false);
                }
            ...
            Minecraft.getMinecraft().getItemRenderer().renderItem(entity, entity.getHeldItem(), ItemCameraTransforms.TransformType.THIRD_PERSON);
