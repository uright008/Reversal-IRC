...
public class Shaders
{
    ...
    public static void resetDisplayListModels()
    {
        if (needResetModels)
        {
            ...
            for (Object a : mc.getRenderManager().getEntityRenderMap().values())
            {
    ...
    private static void checkWorldChanged(World world)
    {
        if (currentWorld != world)
        {
            ...
            {
                int i = oldWorld.provider.getDimensionId();
                int j = world.provider.getDimensionId();
            ...
            try
            {
                for (String s3 : list)
                {
                    ...
                    if (inputstream != null)
                    {
                        ...
                        for (Object a : properties.keySet())
                        {
                        	String s4 = (String)a;
