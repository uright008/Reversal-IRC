...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemOverlays(TTFFontRenderer fr, ItemStack stack, int xPosition, int yPosition)
    {
        this.renderItemOverlayIntoGUI(fr, stack, xPosition, yPosition, (String)null);
    }

    public void renderItemOverlayIntoGUI(TTFFontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text)
    {
        if (stack != null)
        {
            if (stack.stackSize != 1 || text != null)
            {
                ...
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(s, (float)(xPosition + 19 - 2 - fr.getWidth(s)), (float)(yPosition + 6 + 3), 16777215);
                GlStateManager.enableLighting();
