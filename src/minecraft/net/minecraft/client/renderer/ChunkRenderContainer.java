...
import cn.stars.addons.chunkanimator.ChunkAnimator;
...
public abstract class ChunkRenderContainer
{
    ...
    public void preRenderChunk(RenderChunk renderChunkIn)
    {
        ...
        if (Objects.requireNonNull(StarX.INSTANCE.moduleManager.getModule("ChunkAnimator")).isEnabled()) ChunkAnimator.INSTANCE.animationHandler.preRender(renderChunkIn);
    }
